            ...
            {services.map((service, index) => {
              ...
              return (
                <button
                  ...
                  className={`block text-left md:text-[1.5rem] xl:text-[1.65rem] 2xl:text-[1.8rem] font-medium leading-tight transition-colors duration-300 ${
                    isActive
                      ? "text-black"
                      : isPassed
                        ? "text-black"
